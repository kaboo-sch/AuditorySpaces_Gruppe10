...
public class SpaceButtonEvents_Volume : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LevelLabel.text = "Volume: " + "\n" + Mathf.Round(Waldhall.volume * 10000.0f) / 100.0 + "%";
    }
    ...
    public void HitTheButton()
    {
        ...
        if (myObj.name == "ButtonGreenRight")
        {
            ...
            Waldhall.volume += 0.15f;
            LevelLabel.text = "Volume: " + "\n" + Mathf.Round(Waldhall.volume * 10000.0f) / 100.0 + "%";
        }
        else if (myObj.name == "ButtonRedRight")
        {
            //Fader.transform.Translate(0.05f, 0, 0);
            curPos = Fader.transform.position;
            moveDir = new Vector3(0.1f, 0, 0);
            //Monitor.GetComponent<AudioSource>().reverbZoneMix -= 0.15f;
            Waldhall.volume -= 0.15f;
            LevelLabel.text = "Volume: " + Mathf.Round(Waldhall.volume * 10000.0f) / 100.0 + "%";
        }
    }
